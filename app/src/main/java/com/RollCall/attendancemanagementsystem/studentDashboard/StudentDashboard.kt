package com.RollCall.attendancemanagementsystem.studentDashboard
...
import com.RollCall.attendancemanagementsystem.LoginActivity
import com.RollCall.attendancemanagementsystem.MainActivity
import com.RollCall.attendancemanagementsystem.R
import com.RollCall.attendancemanagementsystem.fragment.AboutUsFragment
import com.RollCall.attendancemanagementsystem.fragment.ChangePasswordFragment
...
class StudentDashboard : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        supportFragmentManager.beginTransaction()
            ...
            .addToBackStack("Student Dashboard")
            .commit()
        supportActionBar?.title = "Student Dashboard"
        navigationView.setCheckedItem(R.id.menudrawerStudent)
        ...
        val actionBarDrawerToggle = ActionBarDrawerToggle(this@StudentDashboard,drawerLayout,
        ...
        navigationView.setNavigationItemSelectedListener {
            ...
            when(it.itemId) {
                ...
                R.id.menudrawerChangePassword-> {
                    supportFragmentManager.beginTransaction()
                        .replace(R.id.frame,ChangePasswordFragment())
                        //.addToBackStack("Favouities")
                        .commit()
                    supportActionBar?.title = "Change Password"
                    drawerLayout.closeDrawers()
                }
                R.id.menudrawerAboutus -> {
                    supportFragmentManager.beginTransaction()
                ...
                R.id.menudrawerLogout -> {


                    val dialog:AlertDialog.Builder = AlertDialog.Builder(this@StudentDashboard)
                    dialog.setTitle("Do You Want To LogOut ?")
                    //dialog.setMessage("Internet Connection Found")
                    // it's show Positive Message
                    dialog.setPositiveButton("LogOut") { text, listener ->
                        //do nothing
                        val intent=Intent(this@StudentDashboard,MainActivity::class.java)
